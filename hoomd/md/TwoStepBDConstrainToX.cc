...
/*! \file TwoStepBDConstrainToX.h
    \brief Contains code for the TwoStepBDConstrainToX class
*/
...
*/
TwoStepBDConstrainToX::TwoStepBDConstrainToX(std::shared_ptr<SystemDefinition> sysdef,
  ...
  : TwoStepLangevinBase(sysdef, group, T, seed, use_lambda, lambda),
    ...
    {
    m_exec_conf->msg->notice(5) << "Constructing TwoStepBDConstrainToX" << endl;
    }

TwoStepBDConstrainToX::~TwoStepBDConstrainToX()
    {
    m_exec_conf->msg->notice(5) << "Destroying TwoStepBDConstrainToX" << endl;
    }
...
*/
void TwoStepBDConstrainToX::integrateStepOne(unsigned int timestep)
    {
    ...
    for (unsigned int group_idx = 0; group_idx < group_size; group_idx++)
        ...
        // Initialize the RNG
        RandomGenerator rng(RNGIdentifier::TwoStepBDConstrainToX, m_seed, ptag, timestep);
...
/*! \param timestep Current time step
*/
void TwoStepBDConstrainToX::integrateStepTwo(unsigned int timestep)
    {
    // there is no step 2 in Brownian dynamics.
    }

void export_TwoStepBDConstrainToX(py::module& m)
    {
    py::class_<TwoStepBDConstrainToX, std::shared_ptr<TwoStepBDConstrainToX> >(m, "TwoStepBDConstrainToX", py::base<TwoStepLangevinBase>())
