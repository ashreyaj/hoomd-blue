...
/*! \file TwoStepBDAnisoGammaGPU.h
    \brief Contains code for the TwoStepBDAnisoGammaGPU class
*/
...
*/
TwoStepBDAnisoGammaGPU::TwoStepBDAnisoGammaGPU(std::shared_ptr<SystemDefinition> sysdef,
                           ...
                           bool noiseless_t,
                           bool noiseless_r)
    : TwoStepBDAnisoGamma(sysdef, group, T, seed, use_lambda, lambda, noiseless_t, noiseless_r)
    {
    if (!m_exec_conf->isCUDAEnabled())
        {
        m_exec_conf->msg->error() << "Creating a TwoStepBDAnisoGammaGPU while CUDA is disabled" << endl;
        throw std::runtime_error("Error initializing TwoStepBDAnisoGammaGPU");
        }
...
*/
void TwoStepBDAnisoGammaGPU::integrateStepOne(unsigned int timestep)
    {
    // profile this step
    if (m_prof)
...
*/
void TwoStepBDAnisoGammaGPU::integrateStepTwo(unsigned int timestep)
    {
    // there is no step 2
    }

void export_TwoStepBDAnisoGammaGPU(py::module& m)
    {
    py::class_<TwoStepBDAnisoGammaGPU, std::shared_ptr<TwoStepBDAnisoGammaGPU> >(m, "TwoStepBDAnisoGammaGPU", py::base<TwoStepBDAnisoGamma>())
