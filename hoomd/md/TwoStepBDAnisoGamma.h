...
#ifndef __TWO_STEP_BD_ANISOGAMMA_H__
#define __TWO_STEP_BD_ANISOGAMMA_H__
...
/*! Implements Brownian dynamics.
    ...
    \ingroup updaters
*/
class PYBIND11_EXPORT TwoStepBDAnisoGamma : public TwoStepLangevinBase
    {
    public:
        //! Constructs the integration method and associates it with the system
        TwoStepBDAnisoGamma(std::shared_ptr<SystemDefinition> sysdef,
...
void export_TwoStepBDAnisoGamma(pybind11::module& m);

#endif // #ifndef __TWO_STEP_BD_ANISOGAMMA_H__
