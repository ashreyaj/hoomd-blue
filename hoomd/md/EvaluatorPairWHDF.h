...
#ifndef __PAIR_EVALUATOR_WHDF_H__
#define __PAIR_EVALUATOR_WHDF_H__
...
//! Class for evaluating the WHDF pair potential
//! For reference, see "The Lennard-Jones potential: when (not) to use it."
//
class EvaluatorPairWHDF
    {
    public:
        ...
        */
        DEVICE EvaluatorPairWHDF(Scalar _rsq, Scalar _rcutsq, const param_type& _params)
...
#endif // __PAIR_EVALUATOR_WHDF_H__
