...
#ifndef __TWO_STEP_BD_GAUSSIAN_H__
#define __TWO_STEP_BD_GAUSSIAN_H__
...
/*! Implements Brownian dynamics.
    ...
    \ingroup updaters
*/
class PYBIND11_EXPORT TwoStepBDGaussian : public TwoStepLangevinBase
    {
    public:
        //! Constructs the integration method and associates it with the system
        TwoStepBDGaussian(std::shared_ptr<SystemDefinition> sysdef,
...
void export_TwoStepBDGaussian(pybind11::module& m);

#endif // #ifndef __TWO_STEP_BD_GAUSSIAN_H__
